...
urlpatterns = [
    ...
    path(r"<int:author_id>/write/", views.home_write, name="home_write"),
    path(r"<int:author_id>/read/", views.home_read, name="home_read"),
    path(r"<int:author_id>/write/<int:story_id>/", views.home_write_story, name="home_write_story"),
    path(r"<int:author_id>/read/<int:story_id>/", views.home_read_story, name="home_read_story"),
