...
urlpatterns = [
    ...
    path(r"<int:author_id>/<slug:read_or_write>/", views.home, name="home_write"),
    path(r"<int:author_id>/<slug:read_or_write>/", views.home, name="home_read"),
    path(r"<int:author_id>/<slug:read_or_write>/<int:story_id>/", views.home, name="home_write_story"),
    path(r"<int:author_id>/<slug:read_or_write>/<int:story_id>/", views.home, name="home_read_story"),
